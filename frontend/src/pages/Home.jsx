          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {whatItDoes.map((item, i) => (
              <Reveal key={item.title} delay={100 + i * 70}>
                <FeatureCard title={item.title} description={item.description} accent={item.accent} icon={item.icon} />
              </Reveal>
            ))}
          </div>
        </div>
        ...
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {howItWorks.map((item, i) => (
              <Reveal key={item.step} delay={100 + i * 70} className="card relative h-full p-6">
        ...
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, i) => (
              <Reveal key={feature.title} delay={100 + i * 70}>
                <FeatureCard
                  title={feature.title}
          ...
          <div className="lg:col-span-7">
            <div className="grid gap-4 sm:grid-cols-2">
              {technologies.map((tech, i) => (
                <Reveal key={tech.name} delay={100 + i * 70} className="card p-5">
          ...
          <div className="card relative overflow-hidden bg-gradient-to-br from-brand-700 to-brand-900 p-10 text-white sm:p-14">
            ...
            <div className="relative grid items-center gap-8 lg:grid-cols-12">
              <div className="lg:col-span-8">
                <Reveal as="span" delay={0} className="inline-flex items-center rounded-full bg-white/15 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white">
                  Ready when you are
                </Reveal>
                <Reveal as="h2" delay={100} className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
                  Begin your career conversation with data, not guesswork.
                </Reveal>
                <Reveal as="p" delay={200} className="mt-4 max-w-2xl text-base leading-relaxed text-brand-100">
              ...
              <Reveal delay={300} className="flex flex-wrap items-center gap-3 lg:col-span-4 lg:justify-end">
